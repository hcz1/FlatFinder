...
<head>
    ...
    <title>Flat Finder - New Activation Email</title>
...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand">Flat Finder - New Activation Email</a>
        </div>
...
<div class="container">
    ...
    <c:if test="${activated != null}">
        <div class="alert alert-info" role="alert">
            <strong>Heads Up!</strong> Your FlatFinder account has already been activated, you do not need another activation email.
        </div>
    </c:if>
    <form:form method="POST" action="/confirm/sendNewEmail" modelAttribute="User">
        <table>
            <tr>
